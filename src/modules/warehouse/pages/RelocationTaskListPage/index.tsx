...
const RelocationTaskListPage: FC = () => {
  ...
  const relocationTaskId = Number(searchParams.get('relocationTask')) || undefined
  ...
  const [relocationTaskOpened, { toggle: toggleOpenRelocationTask }] = useBoolean(
    !!selectedRelocationTaskId,
  )
