...
import { findFirstLineButton } from '../WorkGroup/_tests_/utils'
    ...
    describe('Роль - старший инженер', () => {
      describe('При успешный запросе', () => {
        test('Закрывается модальное окно и карточка заявки', async () => {
          ...
          const taskDetailsCard = getTaskDetails()
          await waitFinishLoadingByCard(taskDetailsCard)
          ...
          await waitStartLoadingByButton(firstLineButton)
          await waitFinishLoadingByButton(firstLineButton)
