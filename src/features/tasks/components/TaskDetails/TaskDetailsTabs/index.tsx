...
const SubTasksTab = React.lazy(() => import('./SubTasksTab'))
...
const TaskDetailTabs: FC<TaskDetailTabsProps> = ({
  task,
  ...
  const tabsItems: AntdTabsProps['items'] = [
    ...
    {
      key: TaskDetailsTabsEnum.SubTasks,
      label: taskDetailsTabNameDict[TaskDetailsTabsEnum.SubTasks],
      children: (
