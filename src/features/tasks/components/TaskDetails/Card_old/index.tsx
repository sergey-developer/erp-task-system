...
import {
  ...
  TaskAssigneeDTO,
  TaskDetailDTO,
  TaskReclassificationRequestDTO,
...
import Title from 'features/tasks/components/TaskDetails/TaskDetailsTitle'
...
import { useTaskSuspendRequestStatus } from 'features/tasks/hooks'
...
export type TaskCardProps = {
  ...
  refetchTask: EmptyFn
  reclassificationRequest: MaybeNull<TaskReclassificationRequestDTO>
