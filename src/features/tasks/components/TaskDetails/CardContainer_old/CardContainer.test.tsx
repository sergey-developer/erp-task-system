import { fakeId, notificationTestUtils, setupApiTests } from '_tests_/utils'
...
test.skip('Контейнер детальной карточки заявки', () => {})
...
//
//             const notification = await notificationTestUtils.findNotification(
//               createTaskReclassificationRequestErrorMessage,
//             )
//             expect(notification).toBeInTheDocument()
//           })
//         })
...
//
//             expect(
//               await notificationTestUtils.findNotification(createTaskSuspendRequestErrorMessage),
//             ).toBeInTheDocument()
//           })
//
//           test('Обрабатывается ошибка 400', async () => {
