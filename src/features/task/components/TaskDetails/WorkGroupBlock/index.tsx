...
} from 'features/task/components/TaskFirstLineModal/types'
import {
  TaskSecondLineFormFields,
  TaskSecondLineModalProps,
} from 'features/task/components/TaskSecondLineModal/types'
...
const TaskSecondLineModal = React.lazy(() => import('features/task/components/TaskSecondLineModal'))
