...
import ExecuteInventorizationReviseTab from 'features/warehouse/components/ExecuteInventorizationReviseTab'
import {
  inventorizationStatusDict,
  inventorizationTypeDict,
} from 'features/warehouse/constants/inventorization'
import { useCompleteInventorization } from 'features/warehouse/hooks/inventorization'
...
const ExecuteInventorizationDiscrepanciesTab = React.lazy(
  () => import('features/warehouse/components/ExecuteInventorizationDiscrepanciesTab'),
)

const ExecuteInventorizationRelocationsTab = React.lazy(
  () => import('features/warehouse/components/ExecuteInventorizationRelocationsTab'),
)
