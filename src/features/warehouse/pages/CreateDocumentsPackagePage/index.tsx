...
const CreateCallingReasonModal = React.lazy(
  () => import('features/task/components/CreateCallingReasonModal'),
)

const CompletedWorkTable = React.lazy(
  () => import('features/warehouse/components/CompletedWorkTable'),
)
const CreateCompletedWorkModal = React.lazy(
  () => import('features/task/components/CreateCompletedWorkModal'),
)

const CreateRelocationEquipmentTechnicalExaminationModal = React.lazy(
  () => import('features/warehouse/components/CreateRelocationEquipmentTechnicalExaminationModal'),
)
