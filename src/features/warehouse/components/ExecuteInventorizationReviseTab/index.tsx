...
import { getCheckEquipmentFormInitialValues } from 'features/warehouse/components/CheckEquipmentFormModal/utils'
...
} from 'features/warehouse/components/CreateInventorizationEquipmentModal/types'
...
const CreateInventorizationEquipmentModal = React.lazy(
  () => import('features/warehouse/components/CreateInventorizationEquipmentModal'),
)
...
const CheckEquipmentFormModal = React.lazy(
  () => import('features/warehouse/components/CheckEquipmentFormModal'),
)

const CheckInventorizationEquipmentsModal = React.lazy(
  () => import('features/warehouse/components/CheckInventorizationEquipmentsModal'),
)
