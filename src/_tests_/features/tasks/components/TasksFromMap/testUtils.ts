...
import { TestIdsEnum } from '_tests_/features/tasks/components/TasksFromMap/constants'

const getContainer = () => screen.getByTestId(TestIdsEnum.TasksFromMap)
...
export const tasksFromMapTestUtils = {
  getContainer,
  getChildByText,
