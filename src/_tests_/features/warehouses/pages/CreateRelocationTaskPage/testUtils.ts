...
import { buttonTestUtils, fakeWord } from '_tests_/helpers'

import { TestIdsEnum } from './constants'

const getContainer = () => screen.getByTestId(TestIdsEnum.CreateRelocationTaskPage)
...
export const createRelocationTaskPageTestUtils = {
  getContainer,
